        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 text-center lg:text-left">
              ...
              <h2 className="text-xl md:text-2xl lg:text-3xl font-medium text-slate-700 mb-6 leading-snug">
            ...
            <div className="lg:col-span-5 mt-12 lg:mt-0">
              <div className="relative flex items-center justify-center">
                ...
                <div className="relative w-full max-w-md flex flex-col items-center text-center">
                  ...
                  {/* Logo Image */}
                  <div className="mb-0 relative flex items-center justify-center w-full max-w-[300px] aspect-square md:max-w-[400px] lg:max-w-[500px]">
                  ...
                  <div className="w-full relative z-10 -mt-10 md:-mt-16 lg:-mt-20">
                    <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-slate-900 drop-shadow-md">AVATAR</h3>
                    <p className="text-slate-700 text-sm md:text-base mt-2 font-medium drop-shadow-sm">Mitigasi Bencana Berbasis AI</p>
                  </div>
                </div>
              </div>
            </div>
